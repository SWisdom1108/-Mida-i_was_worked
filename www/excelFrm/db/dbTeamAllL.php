<?php
	...
	$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue(etExcelColumnString($lastColum-4)."2", "001");

	$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue(etExcelColumnString($lastColum-3)."2", "001");

	$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue(etExcelColumnString($lastColum-2)."2", "상담내용");

	$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue(etExcelColumnString($lastColum-1)."2", "TM0000");
