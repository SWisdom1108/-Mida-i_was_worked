<?php
	...
	$query = "
		SELECT * FROM mc_db_cs_status WHERE use_yn = :use_yn AND sms_yn = :sms_yn ORDER BY sort ASC
	";
...
?>
			...
			<table>
				...
				<tbody>
					<tr>
						<th>상담상태 선택</th>
						<td>
							<select name="cs_status_code" class="txtBox">
	...
	<div id="popupBtnWrap">
		...
		<button type="button" class="typeBtn btnGray02 popupCloseBtn" data-target="csStatus">취소</button>
	</div>
						...
						success : function(result){
							switch(result){
								case "success" :
									...
									break;
								case "fail" :
									alert("알 수 없는 이유로 상태변경을 실패하였습니다.");
