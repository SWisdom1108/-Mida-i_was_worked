			...
			<table>
				...
				<tbody>
					<tr>
						<th>다운로드</th>
						<td class="tl">
							<a href="/excelFrm/db/dbTeamL" class="typeBtn btnGreen02"><i class="fas fa-file-download"></i>양식 다운로드</a>
						</td>
					</tr>
					<tr>
							...
							switch(result){
								...
								default :
									...
									$.each(result.data, function(key, value){
										...
										code += (value.fc_code) ? '<td class="lp05">FC' + value.fc_code + '</td>' : "<td>-</td>";
