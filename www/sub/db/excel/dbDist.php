			...
			<table>
				...
				<tbody>
					<tr>
						<th>다운로드</th>
						<td class="tl">
							<a href="/excelFrm/db/dbDistL" class="typeBtn btnGreen02"><i class="fas fa-file-download"></i>양식 다운로드</a>
					</tr>
					<tr>
							...
							switch(result){
								...
								default :
									...
									$.each(result.data, function(key, value){
										...
										code += (value.made_date) ? '<td class="lp05">' + value.made_date + '</td>' : "<td>-</td>";
