...
?>
	...
	<div class="writeWrap">
		<form enctype="multipart/form-data" id="writeFrm" data-ajax="/ajax/db/dbAllWP" data-callback="close" data-type="등록">
					...
					<tr>
						...
						<td>
							...
							<?php 	while($row = $pmList->fetch(PDO::FETCH_ASSOC)){ ?>
								<option value="<?=$row["idx"]?>"><?=dhtml($row["company_name"])?></option>
							<?php } ?>
							</select>
						</td>
