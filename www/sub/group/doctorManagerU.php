...
?>
	...
	<div class="writeWrap">
		<form enctype="multipart/form-data" id="modFrm" data-ajax="/ajax/group/doctorManagerUP" data-callback="/sub/group/doctorManagerV?idx=<?=$view['idx']?>" data-type="수정">
	...
	<div class="dataBtnWrap">
		<div class="left">
			<a href="/sub/group/doctorManagerV?idx=<?=$view['idx']?>" class="typeBtn btnGray02" title="취소"><i class="fas fa-arrow-left"></i>취소</a> 
		</div>
		<div class="right">
