...
?>
	...
	<div class="dataBtnWrap">
		<div class="left">
			<a href="/sub/group/doctorW" class="typeBtn btnMain big"><i class="fas fa-plus-circle"></i>닥터 등록</a>
		</div>
		<div class="right">
		</div>
	</div>
	...
	<div class="listWrap">
		<table>
			...
			?>
				<tr class="rowMove" onclick="www('/sub/group/doctorV?idx=<?=$row['idx']?>');">
					<td class="lp05"><?=listNo()?></td>
					<td class="lp05">DR<?=$row["idx"]?></td>
					<td class="lp05">
						<?=dhtml($row['m_id'])?>
					</td>
