...
?>
	...
	<div class="writeWrap">
		<form enctype="multipart/form-data" id="writeFrm" data-ajax="/ajax/db_setting/dbGradeWP" data-callback="close" data-type="등록">
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td colspan="3"><input type="text" class="txtBox" name="grade_name"></td>
					</tr>
					<tr>
						<th class="important">상세설명</th>
						<td colspan="3"><textarea class="txtBox" name="ex_memo"></textarea></td>
					</tr>
					<tr>
						<th>사용여부</th>
