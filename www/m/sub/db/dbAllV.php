<?php
	...
	# 데이터 정보추출
	$value = array(':use_yn'=>'Y',':dist_code'=>'001',':idx'=>$_GET['idx']);
	$query = "
		SELECT MT.*
	...
	<div class="dataSectionWrap">
		...
		<div class="dataViewWrap">
			...
			<div class="infoWrap">
				<ul>
					<li>
						<span class="label">중복여부</span>
						<span class="value"><?=($view['overlap_yn']=="Y") ? "<span style='color:#CD3333; font-weight: 500;'>중복</span>" : "미중복"?></span>
					</li>
					<li>
				...
				<?php } ?>
					...
					<li>
						...
						<span class="value lp05"><?=($view['pm_name']) ? "PM{$view['pm_code']} ({$view['pm_name']})" : "-"?></span>
					</li>
				</ul>
			</div>
		</div>
