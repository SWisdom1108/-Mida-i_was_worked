...
<?php
	...
	$value = array(':bbs_code'=>$bbs_code, ':notice'=>$notice, ':title'=>$title, ':content'=>$contents, ':etc1'=>$etc1, ':etc2'=>$etc2, ':etc3'=>$etc3, ':etc4'=>$etc4, ':proc_id'=>$proc_id, ':proc_ip'=>$proc_ip);
	$query = "
		INSERT INTO mt_bbs
			( bbs_code, noti_yn, title, content, etc1, etc2, etc3, etc4, reg_idx, reg_ip )
		VALUES
			( :bbs_code, :notice, :title, :content, :etc1, :etc2, :etc3, :etc4, :proc_id, :proc_ip )
	";
